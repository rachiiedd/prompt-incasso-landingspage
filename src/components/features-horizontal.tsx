    ...
    <section ref={ref} id="features">
      <div className="container">
        <div className="max-w-6xl mx-auto ">
          <div className="">
            <div
              className={`hidden md:flex order-1 md:order-[0] w-full justify-around ${
                ltr ? "md:order-2 md:justify-end" : "justify-start"
              }`}
            >
              <Accordion.Root
                className="grid md:grid-cols-3 gap-x-10 py-8 w-full"
                type="single"
                  ...
                  >
                    ...
                    <AccordionTrigger>
                      <div className="flex items-center relative flex-col">
                        ...
                        <div className="justify-center text-center mb-4 max-w-[75%]">
                          {item.content}
                        </div>
                      </div>
                    </AccordionTrigger>
